...
st = TT.time()
batch_size = 32
datapath =model_paths.__path_new_data__[1] ## need to use abs path
...
model.restore(model_paths.__path_to_save_model__[1]+"-"+str(model_paths.__training_epochs_model_2__)+".ckpt") 
# print(model_paths.__path_to_save_model__[1]+"-"+str(model_paths.__training_epochs__)+".ckpt")
